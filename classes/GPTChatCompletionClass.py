...
class GPTChatCompletion:
    ...
    def _openai_gpt_chatcompletion(
        ...
        """
        Sends a list of messages to the OpenAI GPT self.config.model and retrieves a generated response.

        This function interacts with the OpenAI GPT self.config.model to generate responses based on the provided message structure. It attempts to ensure the response is within a specified character limit, retrying up to a maximum number of attempts if necessary.
        ...
        Returns:
        - str: The content of the message generated by the GPT self.config.model. If the maximum number of attempts is exceeded without generating a response within the character limit, an exception is raised.
