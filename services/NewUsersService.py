...
class NewUsersService:
    ...
    async def get_users_not_yet_sent_message(
        ...
        self.logger.info(f"users_not_yet_sent_message (after find_unique_to_new_list(users_sent_messages_list, current_new_usernames)):")
        self.logger.info(f"{users_not_yet_sent_message}")   
